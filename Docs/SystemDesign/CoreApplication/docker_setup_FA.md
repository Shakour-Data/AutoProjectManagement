...
## مثال خروجی
هنگام اجرای راه‌اندازی پس از نصب، خروجی زیر انتظار می‌رود:
```
============================================================
راه‌اندازی Docker AutoProjectManagement
============================================================
✓ Docker قبلاً نصب شده است

در حال راه‌اندازی محیط Docker...
✓ راه‌اندازی محیط Docker تکمیل شد!

سیستم AutoProjectManagement شما اکنون در حال اجرا است!
URLهای دسترسی:
