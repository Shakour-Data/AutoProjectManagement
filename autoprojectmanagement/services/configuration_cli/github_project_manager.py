...
Purpose: GitHub project management CLI tool for creating and managing GitHub projects programmatically
Author: BLACKBOXAI
Version: 1.0.0
License: MIT
Description: A comprehensive CLI tool for managing GitHub projects with support for project creation,
             configuration, and synchronization from JSON templates. Provides both programmatic and
             command-line interfaces for GitHub project management.
"""
