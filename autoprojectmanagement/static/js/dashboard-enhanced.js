// AutoProjectManagement Dashboard JavaScript with Layout Management
class Dashboard {
    constructor() {
        this.projectId = null;
    ...
    applyLayout() {
        ...
        // Reinitialize charts after layout change
        this.initializeCharts();
    }
    ...
    // Rest of the original Dashboard methods (abbreviated for clarity)
