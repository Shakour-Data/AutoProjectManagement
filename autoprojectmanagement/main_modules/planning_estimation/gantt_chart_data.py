"""
Gantt Chart Data Generator Module.

This module provides functionality to generate Gantt chart data from project tasks,
including task dependencies, durations, and progress tracking.
