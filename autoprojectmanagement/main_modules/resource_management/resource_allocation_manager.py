...
================================================================================
Module: resource_allocation_manager
...
Description:
    Resource Allocation Manager module
...
Example:
    >>> from autoprojectmanagement.main_modules.resource_management.resource_allocation_manager import {main_class}
    >>> instance = {main_class}()
    >>> instance.run()
