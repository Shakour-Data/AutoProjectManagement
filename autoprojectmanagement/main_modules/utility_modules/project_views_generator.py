...
Example:
    >>> from autoprojectmanagement.main_modules.utility_modules.project_views_generator import {main_class}
    >>> instance = {main_class}()
    >>> instance.run()
