"""
Auto-generated tests for autoprojectmanagement\main_modules\reporting.py
...
from autoprojectmanagement.main_modules.progress_reporting import reporting

class TestReporting:
    """Test class for reporting module"""
