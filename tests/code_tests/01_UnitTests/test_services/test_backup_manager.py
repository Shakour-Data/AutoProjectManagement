...
================================================================================
Module: test_backup_manager
File: test_backup_manager.py
Path: tests/code_tests/01_UnitTests/test_services/test_backup_manager.py
...
Example:
    >>> from tests.code_tests.01_UnitTests.test_services.test_backup_manager import {main_class}
    >>> instance = {main_class}()
    >>> instance.run()
