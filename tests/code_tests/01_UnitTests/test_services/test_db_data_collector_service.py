...
================================================================================
Module: test_db_data_collector_service
File: test_db_data_collector_service.py
Path: tests/code_tests/01_UnitTests/test_services/test_db_data_collector_service.py

Description:
    Test Db Data Collector Service module
...
Example:
    >>> from tests.code_tests.01_UnitTests.test_services.test_db_data_collector_service import {main_class}
    >>> instance = {main_class}()
    >>> instance.run()
