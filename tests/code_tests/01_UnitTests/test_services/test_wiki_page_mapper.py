...
================================================================================
Module: test_wiki_page_mapper
File: test_wiki_page_mapper.py
Path: tests/code_tests/01_UnitTests/test_services/test_wiki_page_mapper.py

Description:
    Test Wiki Page Mapper module
...
Example:
    >>> from tests.code_tests.01_UnitTests.test_services.test_wiki_page_mapper import {main_class}
    >>> instance = {main_class}()
    >>> instance.run()
