...
================================================================================
Module: test_do_urgent_tasks
File: test_do_urgent_tasks.py
Path: tests/code_tests/01_UnitTests/test_services/test_do_urgent_tasks.py

Description:
    Test Do Urgent Tasks module
...
Example:
    >>> from tests.code_tests.01_UnitTests.test_services.test_do_urgent_tasks import {main_class}
    >>> instance = {main_class}()
    >>> instance.run()
